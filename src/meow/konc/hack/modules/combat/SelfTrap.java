...
import static meow.konc.hack.modules.player.Scaffold.faceVectorPacketInstant;
...
public class SelfTrap extends Module {
    ...
    private Setting<Cage> cage = register(Settings.e("Cage", Cage.BLOCKOVERHEAD));
    ...
    public void onUpdate() {
        ...
        if (cage.getValue().equals(Cage.BLOCKOVERHEAD)) {
