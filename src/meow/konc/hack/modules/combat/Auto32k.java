...
import static meow.konc.hack.modules.hidden.util.KamiCrystal.getPlayerPos;
...
public class Auto32k extends Module {
    ...
    private Setting<Boolean> autoEnableHitKillAura = register(Settings.b("Auto enable Hit KillAura", true));
    ...
    protected void onEnable() {
        ...
        KamiCrystal KamiCrystal = (KamiCrystal) ModuleManager.getModuleByName("KamiCrystal");
        List<BlockPos> placeTargetList = KamiCrystal.getSphere(getPlayerPos(), range, range, false, true, 0);
