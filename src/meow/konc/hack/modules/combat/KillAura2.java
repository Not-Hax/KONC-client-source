...
import meow.konc.hack.modules.misc.AutoTool;
...
@Module.Info(name = "KillAura2", category = Module.Category.COMBAT, description = "Hits entities around you")
public class KillAura2 extends Module {
    ...
    private Setting<Boolean> multi = register(Settings.b("Multi", false));
    ...
    private Setting<Boolean> sync = register(Settings.b("TPS Sync", true));
