package meow.konc.hack.gui.rgui.render.util;

import java.util.HashMap;
import java.util.Map;

import static meow.konc.hack.gui.rgui.render.util.ShaderHelper.createProgram;
import static meow.konc.hack.gui.rgui.render.util.ShaderHelper.loadShader;
