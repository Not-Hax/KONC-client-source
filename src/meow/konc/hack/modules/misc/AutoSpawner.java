...
import static meow.konc.hack.util.packet.BlockInteractionHelper.*;
...
public class AutoSpawner extends Module {
    ...
    public void onUpdate() {
        ...
        if (buildStage == 1) {
            ...
            List<BlockPos> blockPosList = KamiCrystal.getSphere(mc.player.getPosition().down(), placeRange.getValue(), placeRange.getValue().intValue(), false, true, 0);
