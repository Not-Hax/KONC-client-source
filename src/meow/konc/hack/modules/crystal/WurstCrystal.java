...
@Module.Info(name = "WurstCrystal", category = Module.Category.CRYSTAL)
public class WurstCrystal extends Module {
    ...
    private void drawBlock(final BlockPos blockPos, final int r, final int g, final int b) {
        ...
        if (this.renderMode.getValue().equals(RenderMode.UP)) {
            KONCTessellator.drawBox(blockPos, color.getRGB(), 2);
        } else if (this.renderMode.getValue().equals(RenderMode.SOLID)) {
            KONCTessellator.drawBox(blockPos, color.getRGB(), 63);
            ...
            KONCTessellator.drawBoundingBox(iBlockState2.getSelectedBoundingBox((World) mc.world, blockPos).offset(-interp2.x, -interp2.y, -interp2.z), 1.5f, r, g, b, this.alpha.getValue());
        } else {
            ...
            KONCTessellator.drawFullBox(iBlockState3.getSelectedBoundingBox((World) mc.world, blockPos).offset(-interp3.x, -interp3.y, -interp3.z), blockPos, 1.5f, r, g, b, this.alpha.getValue());
        }
