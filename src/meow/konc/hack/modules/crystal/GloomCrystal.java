...
@Module.Info(name = "GloomCrystal", category = Module.Category.CRYSTAL)
public class GloomCrystal extends Module {
    ...
    public void onWorldRender(RenderEvent event) {
        if (render != null) {
            ...
            KONCTessellator.drawBox(render, Red.getValue().intValue(), Green.getValue().intValue(), Blue.getValue().intValue(), Alpha.getValue().intValue(), GeometryMasks.Quad.ALL);
    ...
    protected void onEnable() {
        if (alert.getValue()) {
            Command.sendChatMessage("[GloomCrystal] " + ChatFormatting.GREEN.toString() + "Enabled!");
        }
    }
