package meow.konc.hack.modules.hidden.capes;
...
public class Capes extends Module {
    ...
    public Setting<Boolean> overrideOtherCapes = register(Settings.b("Override Other Capes", false));
    ...
    public void onEnable() {
        ...
        if (!hasBegunDownload) {
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        HttpsURLConnection connection = (HttpsURLConnection) new URL(KONCMod.CAPES_JSON).openConnection();
                        connection.connect();
                        ...
                        KONCMod.log.error("Failed to load capes");
                        // e.printStackTrace();
                    }
                }
            }.start();
    ...
    public void onDisable() {
        Module module = ModuleManager.getModuleByName("Capes");
        module.enable();
    }
