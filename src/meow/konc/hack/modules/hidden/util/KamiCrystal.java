 ...
 */
@Module.Info(name = "KamiCrystal", category = Module.Category.UTIL, description = "Places End Crystals to kill enemies")
public class KamiCrystal extends Module {
    ...
    public Setting<Double>  range = register(Settings.d("Range", 4));
    ...
    public void onWorldRender(RenderEvent event) {
        if (render != null) {
            ...
            KONCTessellator.drawBox(render, 0x44ffffff, GeometryMasks.Quad.ALL);
